...
def get_random_buffers_double_backward(tpp : TPProblem, batch_size : int, prng_seed : int) -> tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
    """
    ...
    return in1, in2, out_grad, weights, weights_grad, in1_grad, in2_grad, out_double_grad 
